...
local USERAGENT = 'moonstalk.resty.http/' .. _VERSION
...
-- global variables
local url = require("openresty/include/url")

local mt = {} -- { __index = resty.http } -- FIXME: this is not namespaced and should be ourself thus providing object syntax with all our methods
